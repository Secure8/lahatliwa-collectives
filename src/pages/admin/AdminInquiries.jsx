...
export default function AdminInquiries() {
  ...
  useEffect(() => {
    ...
    const closeOnEscape = (event) => { if (event.key === 'Escape' && !updatingId) setSelected(null); };
