...
export default function CollectiveHero({ content }) {
  ...
  const heroEyebrow = usesUnapprovedReplacement ? PRESERVED_COLLECTIVE_HERO.eyebrow : (content.home.heroEyebrow || PRESERVED_COLLECTIVE_HERO.eyebrow);
  const heroTitle = usesUnapprovedReplacement ? PRESERVED_COLLECTIVE_HERO.title : (content.home.heroTitle || PRESERVED_COLLECTIVE_HERO.title);
  const heroDescription = usesUnapprovedReplacement ? PRESERVED_COLLECTIVE_HERO.description : (content.home.heroDescription || PRESERVED_COLLECTIVE_HERO.description);
  ...
  const primaryLabel = content.home.primaryCta || PRESERVED_COLLECTIVE_HERO.primaryCta;
  const secondaryLabel = content.home.secondaryCta || PRESERVED_COLLECTIVE_HERO.secondaryCta;
