...
export const WEBSITE_STUDIO_SECTIONS = [
  ...
  { group: 'Shared across the website', label: 'Navbar', key: 'global.navigation', fields: [
    ['homeLabel', 'Feed', 'text'], ['aboutLabel', 'About', 'text'], ['currentWorkLabel', 'Work', 'text'], ['projectsLabel', 'Portfolio', 'text'], ['creativesLabel', 'Creatives', 'text'], ['contactLabel', 'Contact', 'text'], ['servicesLabel', 'Services', 'text'], ['privacyLabel', 'Privacy', 'text'], ['showAbout', 'Show About', 'boolean'], ['showProjects', 'Show Portfolio', 'boolean'], ['showCreatives', 'Show Creatives', 'boolean'], ['showContact', 'Show Contact', 'boolean'],
  ] },
  ...
  { group: 'Public pages', label: 'Work', key: 'page.explore', preview: '/work', fields: [['eyebrow','Eyebrow','text'],['title','Heading','text'],['description','Description','textarea']] },
