...
function StoryEditor({ id }) {
  ...
  return <section className="editorial-studio-page pb-24 md:pb-0">
    ...
    <div className="mx-4 mt-6 flex flex-wrap justify-end gap-2 border-t border-white/[0.08] pt-5 sm:mx-6 lg:mx-8">
      ...
      {canControl && capabilities.canDeleteOwn && post.status === 'archived' && <button onClick={deleteStory} className="h-10 rounded-full border border-red-300/20 bg-[#11110f] px-4 text-sm text-red-100 shadow-xl"><Trash2 size={15} className="mr-2 inline" />Delete permanently</button>}
    </div>
    {confirmationDialog}
  </section>;
}
