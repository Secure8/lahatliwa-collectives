...
test('Website Studio presents the requested sections and keeps shared values synchronized', () => {
  ...
  assert.deepEqual(WEBSITE_STUDIO_SECTIONS.map(({ label }) => label), ['Overview', 'Branding', 'Navbar', 'Feed', 'Discover', 'About', 'Creatives', 'Footer Contact & Inquiry', 'Privacy Policy', 'Colors']);
