...
export default function InquiryConfirmation() {
  ...
  return <div className="page-shell py-16 sm:py-20">
    <PublicPageHeader eyebrow="Request received" title={copy.confirmationTitle} description={copy.confirmationDescription} accentColor={content.accentColor} titleColor={content.primaryTextColor} bodyColor={content.secondaryTextColor} />
    <section className="mt-10 grid gap-8 border-y border-white/[0.09] py-8 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-start">
      <div>
        ...
        <p className="mt-5 max-w-2xl text-sm leading-7 text-zinc-400">{copy.matchingCopy} This request does not confirm a booking, schedule, support appointment, or final quotation.</p>
      </div>
