...
function BranchWorkspace({ branch, content }) {
  ...
  return <div className="pt-10">
    ...
    {branch.key === 'tech' && <p className="py-4 text-xs leading-6 text-zinc-500">Lahat Liwa provides independent visitor information and content support. It is not an official tourism office, booking authority, transport provider, tour operator, or emergency service.</p>}
