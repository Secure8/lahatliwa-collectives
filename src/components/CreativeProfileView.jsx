  ...
  return <article className="relative isolate min-w-0 overflow-hidden">
    ...
    {!adminPreview && <footer id="contact" className="scroll-mt-24 border-t border-orange-300/60 py-8 sm:py-10">
      ...
      <div className="mt-5 grid gap-7 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
        ...
        <div className="flex flex-wrap gap-4"><Link to="/inquiry" className="inline-flex min-h-11 items-center gap-2 bg-orange-300 px-5 text-sm font-semibold text-zinc-950 hover:bg-orange-200">Inquire <ArrowRight size={16} /></Link><Link to="/creatives" className="inline-flex min-h-11 items-center border-b border-white/20 text-sm text-zinc-300 hover:text-white">Creatives</Link></div>
      </div>
    </footer>}
    </div>
  </article>;
