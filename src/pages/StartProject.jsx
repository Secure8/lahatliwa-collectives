...
export default function StartProject() {
  ...
  return <div className="page-shell">
    <PublicPageHeader eyebrow={page.landingEyebrow || (platformInquiry ? 'Contact Lahat Liwa' : 'Connect with a Creative')} title={page.landingHeading || (platformInquiry ? 'Message the people behind the platform.' : 'Start a private creative conversation.')} description={page.landingDescription || (platformInquiry ? 'Use this for questions about Lahat Liwa, the website, profiles, credits, or the network itself.' : 'Choose who you want to work with, then describe the project, opportunity, or collaboration directly.')} backgroundImage={page.heroBackgroundImageUrl} backgroundPosition={page.heroBackgroundPosition || 'center'} edit={{ section: 'page.inquiries', eyebrowField: 'landingEyebrow', titleField: 'landingHeading', descriptionField: 'landingDescription', backgroundField: 'heroBackgroundImageUrl' }} />
