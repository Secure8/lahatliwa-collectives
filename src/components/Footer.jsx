    ...
    <footer className="mt-28 border-t border-white/[0.07]">
      <div className="page-shell grid gap-10 py-12 md:grid-cols-[1.4fr_1fr]">
        ...
        <div className="flex flex-wrap items-start gap-3 md:justify-end">
          <a className="border border-white/10 p-2 text-zinc-300 transition hover:border-amber-300/60 hover:text-amber-200" href={`mailto:${content.email}`} aria-label="Email">
            <Mail size={18} />
          </a>
          {instagram?.href && <a className="border border-white/10 p-2 text-zinc-300 transition hover:border-amber-300/60 hover:text-amber-200" href={instagram.href} aria-label="Instagram">
            <Instagram size={18} />
          </a>}
          {github?.href && <a className="border border-white/10 p-2 text-zinc-300 transition hover:border-amber-300/60 hover:text-amber-200" href={github.href} aria-label="GitHub">
            <Github size={18} />
          </a>}
